...
struct ContentView: View {
    ...
    @State private var guitarSelected = true
        ...
        GeometryReader { geo in
            ...
            ZStack{
                if guitarSelected{
                    ...
                    PianoView(recorder: recorder, keys: keys, chordPlayer: chordPlayer)
                }
        }.overlay(alignment: .top){
                Button{
                    guitarSelected.toggle()
                } label:{
...
#Preview {
    ...
    return ContentView(keys: PianoController(audioController: recorder), recorder: recorder)
}
